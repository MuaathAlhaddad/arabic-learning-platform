...
<div class="container card_container bg-white mt-5 mb-5 p-4" >
             <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Lesson Four</li>
                </ol>
              </nav>
                    
                <div id="lesson_one" class="container d-flex flex-column justify-content-center align-items-center">
                        <h1 style="font-family:'sukar_bold';" class="mt-2 mb-5">الدرس الرابع</h1>
                        <object width="100%" height="600px" data="{{asset('materials/الدرس الرابع_الأسرة.pdf')}}"></object>
                </div>
</div>  
@endsection