              ...
              <!--  Start of Personal Details section -->
                <div class="card">
                    ...
                    <div class="card-header" id="headingOne">
                        <h5 class="mb-0">
                          <a class="btn btn-link d-flex justify-content-center " data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            <i class="large material-icons pr-1">person</i>
                        ...
                        <div class="card-body">
                          ...
                          <div class="form-row col-sm-12">
                            <div class="form-group col-sm-12">
                              <input type="text" class="form-control" name="ic_passport_no" placeholder="IC/PassportNo">
                            </div>
                          </div>
               ...
               <!--  Start of Tuition Details section -->
                <div class="card">
                    
                  <div class="card-header" id="headingTwo">
                        <h5 class="mb-0">
                          <a class="btn btn-link collapsed d-flex justify-content-center" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                              <i class="large material-icons pr-1">school</i>
                              <h5 class="font-weight-bold">TUITION DETAILS</h5>
                          </a>
                        </h5>
                    </div>
                      ...
                      <div class="card-body">
                            ...
                            <div class="form-row col-sm-12">
                              <div class="form-group col-sm-12">
                                ...
                                <textarea class="form-control" name="tutor_desc" rows="3"></textarea>
                              </div>
                            </div> 
                        ...
                        <!--  End of Tuition Details section -->
                      </div>      
